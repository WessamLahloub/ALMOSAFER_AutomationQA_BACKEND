...
almosafer-api-tests/src/test/ALMOSAFER_TASK.java/ Contains the task Automated APIs.
...
Browser's link should be similar to the following : file:///D:/ALMOSAFER_BEQA_TASK/almosafer-api-tests/target/extent-report.html
